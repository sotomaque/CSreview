 ...
 * @param {*} rightCount 
 */
function generateValidParenthesis(n, result = [], leftCount = n, rightCount = n) {
    ...
    if (leftCount === rightCount) {
        generateValidParenthesis(n - 1, [...result, '('], leftCount - 1, rightCount);
    }
    ...
    if (rightCount > leftCount) {
        ...
        generateValidParenthesis(n - 1, [...result, ')'], leftCount, rightCount - 1);
    }
}
